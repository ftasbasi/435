...
print('The R1 is ready to receive...') 							# printing just to see that the router1 is on and ready to serve 
...
while True:
    ...
    if len(message)==11:										# send the incoming datagram to destination
    	print "Message sent from R1 to Destination:", message 	# print the sent message
